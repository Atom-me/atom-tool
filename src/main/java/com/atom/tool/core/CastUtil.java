        ...
        if (Objects.nonNull(obj)) {
            ...
            if (StringUtils.isNotEmpty(strValue)) {
                try {
                    ...
                    log.warn("cast to double failure use default value [{}]", defaultValue);
                }
            }
        }
        return doubleValue;
        ...
        if (Objects.nonNull(obj)) {
            ...
            if (StringUtils.isNotEmpty(strValue)) {
                try {
                    ...
                    log.warn("cast to long failure use default value [{}]", defaultValue);
                }
            }
        }
        return longValue;
        ...
        if (Objects.nonNull(obj)) {
            ...
            if (StringUtils.isNotEmpty(strValue)) {
                try {
                    ...
                    log.warn("cast to int failure use default value [{}]", defaultValue);
                }
            }
        }
        return intValue;
